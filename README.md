...
Stellar Frontier 是一个星球基地管理与叙事决策游戏原型。玩家从控制中心出发，通过通讯台联系队员，在通话中处理事件和下达指令；修复奥德赛号雷达装置后，可以通过地图查看完整星球地块、视觉素材、地块对象与队员状态。
...
- 地图页面在雷达装置修复后只负责展示信息与辅助选点；对队员的移动、建设、调查和停止工作等指令通过通讯台和通话页面完成。
