...
| [通话](pages/通话.md) | 承载基础行动确认、剧情选择和紧急事件决策。 | 选择回复、在雷达装置修复后打开地图查看坐标信息、打开通讯录浮层、请求队员移动、待命、停止或调查；剧情动作由事件选项提供。 |
| [地图](pages/地图.md) | 雷达装置修复后展示完整星球地图、视觉地块、地块对象、特殊状态和队员状态。 | 缩放 / 平移地图、选择坐标点、查看地形 / 天气 / 对象 / 状态 / 队员位置；从通话进入时只标记候选目的地，不直接发起指令。 |
...
| [控制中心](pages/控制中心.md) | 卫星雷达 | [地图](pages/地图.md) | 奥德赛号雷达装置修复前为离线；修复后点击进入地图页面，用于查看星球地块、地块对象、特殊状态和队员位置。 |
...
| [通话](pages/通话.md) | 地图二级菜单 | [地图](pages/地图.md) | 雷达装置修复后，通话中可以打开地图查看坐标、地形、对象、状态和队员位置；指令仍在通话页发起。 |
