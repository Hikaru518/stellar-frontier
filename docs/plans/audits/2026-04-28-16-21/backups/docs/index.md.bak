...
| [事件系统](./gameplay/event-system/event-system.md) | 事件系统负责把队员行动、地块状态、时间推进和玩家通话选择转化为可验证、可推进、可结算的世界反馈。 | 2026-04-27 | 已实现 |
| [可配置地图系统](./gameplay/map-system/map-system.md) | 地图系统是玩家通过雷达 / 地图理解星球现场态势的基础系统，由可配置尺寸的网格地图构成。 | 2026-04-27 | 已实现 |
